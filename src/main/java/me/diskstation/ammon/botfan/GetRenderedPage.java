 ...
 */
public class GetRenderedPage extends MWAction {

  private static final Logger log = LoggerFactory.getLogger(GetRenderedPage.class);
  ...
  public GetRenderedPage(MediaWikiBot bot, String page) {
    this.bot = bot;
